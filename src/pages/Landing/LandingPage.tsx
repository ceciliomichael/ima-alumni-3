      ...
      <div className="landing-center">
        ...
        <div className="quote-section">
          <p className="quote-text">
            "Once an Immaculatian, always an Immaculatian! Proud to be part of Immaculate 
            Mary Academy, where dreams begin and success continues. Forever grateful for the 
